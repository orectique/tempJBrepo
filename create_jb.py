...
"""
    ...
    try:
        for chapter in chapter_meta.keys():
            ...
            with open(f"./jl/{chapter}.md", "w", encoding='utf-8') as b:
                ...
                for sub in chapter_subs.keys():
                    with open(f"./jl/{sub}", "r", encoding='utf-8') as g:
...
"""
    ...
    try:
        for chapter in chapter_meta.keys():
            ...
            with open(f"./py/{chapter}.md", "w", encoding='utf-8') as b:
                new_header = header.replace("placeholder_text", chapter_name)
                b.write(new_header)
                b.write(f"# {chapter_name}\n\n")
                b.write(contents)
                ...
                for sub in chapter_subs.keys():
                    with open(f"./py/{sub}", "r", encoding='utf-8') as g:
